> ACTIVE PROGRAM: Foundation, governed by DEVELOPMENT-OPERATING-SYSTEM.md and PRODUCT-SCHEDULER.md. This file describes technical rungs, not competing priorities. R4 and its 66-case recovery abuse gate are complete in 0.63.40; R5 and its concurrency gate are complete in 0.63.41. Current work: R6 → R7 → closeout. R8 immediate evidence is complete (30-day retention sampling continues); R9 is preflighted and awaits a supported local runtime and weights. R6 and R7 share Foundation Phase 9 but remain separate measured releases. No parallel product missions.
>
