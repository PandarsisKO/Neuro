> ACTIVE PROGRAM: Foundation, governed by DEVELOPMENT-OPERATING-SYSTEM.md and PRODUCT-SCHEDULER.md. This file describes technical rungs, not competing priorities. Current work: deliver the 0.63.39 Phase 1/2 closeout candidate; then R8 evidence → R9 → R4 → recovery gate → R5 → concurrency gate → R6 → R7 → closeout. R6 and R7 share Foundation Phase 9 but remain separate measured releases. No parallel product missions.
>
