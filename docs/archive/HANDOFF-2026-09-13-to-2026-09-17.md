# HANDOFF.md — entries 2026-09-13 → 2026-09-17 (archived 2026-09-21)

Cut from `HANDOFF.md` by the repo audit. History only; nothing here is an assignment. The 2026-09-12 "Start here" block is kept first because later entries refer to it.
