...
Next incomplete T1 work is locator reconciliation, project-relative similarity distributions, and a fresh
version-stamped measurement cohort. T2 persisted coverage states and UI work remain out of scope until that gate.
