...
5. Small follow-ups Kyle will notice: the Research questions' "N promising sources known" link should land on the 🔎 pool filtered to that question; a "capture the N that fit" bulk action on the pool; the first live measurement of how many findings a deep read yields on a 3-hour source (record in EXPANSION.md).
