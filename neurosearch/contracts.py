...
def _base() -> dict[str, InferenceContract]:
    ...
    return {c.task: c for c in [
        ...
        InferenceContract("rank.relevance", "anthropic", m, max_output_tokens=6000, batch_allowed=True, schema="rank-v1"),
        ...
        InferenceContract("planner.update", "anthropic", m, max_output_tokens=4000, timeout=600.0),
