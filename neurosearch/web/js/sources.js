  ...
  $('#reviewWrap').innerHTML = rvs.map((c, idx) => {
    ...
    const rankLine = !ranked
      ...
      : scored
        ...
        : `<span class="muted">${esc(meta.rank_note || 'Newest first.')} Add a goal or brief in Settings and re-rank to sort by relevance.</span><button class="small ghost push-right" onclick="rvRerank('${c.id}')">re-rank</button>`;
